...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="@if (auth()->user()->hasRole('Pelanggan')) {{ route('home') }} @else {{ route('admin.dashboard') }} @endif"
        class="brand-link">
        <img src="{{ asset('assets/images/Favicon-LJN.png') }}" alt="Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
